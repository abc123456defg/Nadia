...
public class FontUtils {
    ...
    private final Fonts unicodeFont;
    ...
    public FontUtils(String fontName, int fontType, int size, int kerning, boolean allChar, int yAddon) {
        this.unicodeFont = new Fonts(getFont(fontName, fontType, size), true, kerning, allChar, yAddon);
        this.kerning = 0;
    ...
    public float getHeight() {
        return unicodeFont.getHeight("NadiaIsThatBestClarinet.") / 2.0F;
    }
